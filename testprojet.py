...
listAction.bind('<<ListboxSelect>>', func.onSelectAction) #evenement de listAction #quand on selectionne une/des action(s)
...
func.setCadre(cadre) #mettre Canvas dans commun.py pour qu'on puisse l'utiliser
